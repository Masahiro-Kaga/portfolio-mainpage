            ...
            <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                ...
                <div className="relative flex flex-row justify-between">
                  ...
                  <a href="https://github.com/Masahiro-Kaga/portfolio_SantaShooting" target="_blank" rel="noreferrer">
            ...
            <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                ...
                <div className="relative flex flex-row justify-between">
                  ...
                  <a href="https://github.com/Masahiro-Kaga/practiceFour" target="_blank" rel="noreferrer">
                    <div className="bg-white rounded-lg w-10 h-10">
                      <img src="img/github-icon.svg" alt="" />
                    </div>
                  </a>
            ...
            <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                ...
                <div className="relative flex flex-row justify-between">
                  ...
                  <a href="https://github.com/Masahiro-Kaga/portfolio-blog-app" target="_blank" rel="noreferrer">
                    <div className="bg-white rounded-lg w-10 h-10">
                      <img src="img/github-icon.svg" alt="" />
                    </div>
                  </a>
            ...
            <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                ...
                <div className="relative flex flex-row justify-between">
                  ...
                  <a href="https://github.com/Masahiro-Kaga/portfolio" target="_blank" rel="noreferrer">
                    <div className="bg-white rounded-lg w-10 h-10">
                      <img src="img/github-icon.svg" alt="" />
                    </div>
                  </a>
            ...
            <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                ...
                <div className="relative flex flex-row justify-between">
                  ...
                  <a href="https://github.com/Masahiro-Kaga/portfolio-ECwebsite" target="_blank" rel="noreferrer">
                    <div className="bg-white rounded-lg w-10 h-10">
                      <img src="img/github-icon.svg" alt="" />
                    </div>
                  </a>
            ...
            <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                ...
                <div className="relative flex flex-row justify-between">
                  ...
                  <a href="https://masahiro-kaga.github.io/portfolio-mainpage-proto/" target="_blank" rel="noreferrer">
                    <div className="bg-white rounded-lg w-10 h-10">
                      <img src="img/github-icon.svg" alt="" />
                    </div>
                  </a>
